...
public class MainActivity<connected> extends AppCompatActivity {
    EditText mail, pass;
    FirebaseAuth auth;
    ...
    public void reset(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.reset, null,
                false);
        ...
        b.setPositiveButton("Reset", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (e.isEmpty()) {
                    ...
                    auth.sendPasswordResetEmail(e).addOnCompleteListener
                            (MainActivity.this,
                                    new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                Toast.makeText(MainActivity.this,
                                                        "Invalid Mail", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
            }
